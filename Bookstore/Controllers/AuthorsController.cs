...
namespace Bookstore.Controllers
{
    ...
    public class AuthorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description")] Author author)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description")] Author author)
        {
            if (id != author.Id)
            {
                return NotFound();
